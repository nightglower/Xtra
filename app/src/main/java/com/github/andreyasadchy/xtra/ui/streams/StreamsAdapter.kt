...
class StreamsAdapter(
    ...
    private val gameClickListener: GamesFragment.OnGameSelectedListener) : BasePagedListAdapter<Stream, StreamsAdapter.ViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(FragmentStreamsListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class ViewHolder(private val binding: FragmentStreamsListItemBinding): RecyclerView.ViewHolder(binding.root) {

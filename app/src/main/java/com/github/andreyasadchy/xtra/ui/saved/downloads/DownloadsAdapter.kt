...
class DownloadsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(FragmentDownloadsListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class ViewHolder(private val binding: FragmentDownloadsListItemBinding): RecyclerView.ViewHolder(binding.root) {
